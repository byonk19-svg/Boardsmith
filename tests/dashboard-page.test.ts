...
describe("DashboardPage", () => {
  it("renders private workspace hierarchy, project counts, recent projects, and clear actions", async () => {
    ...
    expect(markup).toContain("Needs a generated plan");
    expect(markup).toContain("Ready to review or print");
    expect(markup).toContain("Draft intake saved. Generate a first plan from the project detail page.");
    expect(markup).toContain("Generated plan saved. Review before building or printing.");
    ...
    expect(markup).toContain("Next: review before building or print a shop sheet.");
