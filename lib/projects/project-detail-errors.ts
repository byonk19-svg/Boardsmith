...
const projectDetailErrorMessages = new Map<string, string>([
  ...
  ["clarification_answers_failed", "Clarification answers could not be saved. Review the Project Intake details before trying again."],
  ["clarification_answers_invalid", "Clarification answers were not saved. Enter at least one valid answer before retrying."],
  ["clarification_answers_schema_missing", "Clarification answers were not saved because the database needs the latest project schema."],
