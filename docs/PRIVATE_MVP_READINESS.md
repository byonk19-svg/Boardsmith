...
1. Keep using the wall-shelf Buying Plan manually; only expand behavior if the explicit buying decisions remain repeatedly annoying in real buying/building use.
